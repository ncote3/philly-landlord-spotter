...
export default function MapboxPropertyMap({landlord, data, loading, error}) {
    ...
    if (loading) {
        return (
            <div style={{ marginTop: '10vh' }}>
                <Spinner animation="border" variant="primary" size={'lg'} >
                    <span className="sr-only">Loading Map & Points...</span>
                </Spinner>
        ...
        return (
            <div style={{height: '70vh', width: '100%'}} className='MapboxPropertyMapWrapper'>
                ...
                <ReactMapGL
                    ...
                    mapboxApiAccessToken=
                        'pk.eyJ1IjoibmNvdGUzIiwiYSI6ImNrY2t5dWQ3cDBmaXQydHQ4b3VoODdmemIifQ.QT2VDIQGlElLnAENpCilpA'
